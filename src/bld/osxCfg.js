...
const setOsxConfig = async (pkg, outDir) => {
    ...
    let helper_app_path_alerts = (name = "nwjs") => `${outDir}/nwjs.app/Contents/Frameworks/nwjs Framework.framework/Versions/${chromium_version}/Helpers/${name} Helper (Alerts).app`;
    let helper_app_path_gpu = (name = "nwjs") => `${outDir}/nwjs.app/Contents/Frameworks/nwjs Framework.framework/Versions/${chromium_version}/Helpers/${name} Helper (GPU).app`;
    let helper_app_path_plugin = (name = "nwjs") => `${outDir}/nwjs.app/Contents/Frameworks/nwjs Framework.framework/Versions/${chromium_version}/Helpers/${name} Helper (Plugin).app`;
    ...
    let helper_app_path = (name = "nwjs") => `${outDir}/nwjs.app/Contents/Frameworks/nwjs Framework.framework/Versions/${chromium_version}/Helpers/${name} Helper.app`;
    ...
    await fs.rename(helper_app_path_renderer(), helper_app_path_renderer(pkg.name));
