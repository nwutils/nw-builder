...
__export(src_exports, {
  ...
  validateOptions: () => validateOptions_default
});
...
// src/utilities/validateOptions.js
...
var validateOptions = (options) => {
  ...
  let pkg = {};
  if (typeof options.files === "string" && import_fs2.default.lstatSync(options.files).isDirectory() && import_fs2.default.existsSync(`${options.files}/package.json`)) {
    pkg = import_fs2.default.readFileSync(`${options.files}/package.json`, "utf8");
    pkg = JSON.parse(pkg);
  }
  if (pkg.nwbuild) {
...
var validateOptions_default = validateOptions;
