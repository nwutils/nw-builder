...
Using npm:
```javascript
npm install create-nw-app
```

Using yarn:
```javascript
yarn add create-nw-app
```

Using pnpm:
```javascript
pnpm add create-nw-app
```

## Usage

The best way to get started is to see how our example works using the CLI and the module.
...
`pnpm demo` runs the demo app using the module.
