    ...
    this._plattforms.forEach(function (single_plattform) {
        ...
        if(single_plattform.plattform === 'osx') {
            ...
            if(!self.options.macZip) {
                ...
                copiedFiles.push(Utils.copyFile(self._nwFile, path.resolve(single_plattform.releasePath, 'node-webkit.app', 'Contents', 'Resources', 'app.nw')));
            }
        } else {
...
NwBuilder.prototype.handleMacApp = function () {
    ...
    var macPlattform = _.where(self._plattforms, {'plattform':'osx'});
