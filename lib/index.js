...
NwBuilder.prototype.checkVersion = function () {
    var version = this.options.version,
        flavor = semver.satisfies(version, '<0.12.3') ? 'sdk' : this.options.flavor,
        self = this;
...
NwBuilder.prototype.platformFilesForVersion = function () {
    ...
    if(self._version.isLegacy) {
        this._forEachPlatform(function (name, platform) {
            ...
            if (!satisfied) {
                throw new Error("Unsupported NW.js version '" + self._version.version + " (" + self._version.flavor + ")' for platform '" + platform.type + "'");
            }
        });
    ...
    self._forEachPlatform(function (name, platform) {
        if(!self._version.platforms[name + '-' + self._version.flavor]){
