        ...
        return manifest.versions
            ...
            .map(function (versionFromManifest) {
                return new Version({
                    ...
                    supportedPlatforms: mapFilesToPlatforms(
                        versionFromManifest.files
                    ),
                    downloadUrl: downloadUrl,
                });
            });
...
module.exports = {
    ...
    getVersion: function (args) {
        return (isLegacyVersion(args.desiredVersion)
            ? getLegacyVersions
            : getVersionsFromManifest)(args.downloadUrl, args.manifestUrl).then(
            function (versions) {
                ...
                return version >= 0
                    ...
                    : Promise.reject(
                          "Version " + args.desiredVersion + " not found."
                      );
            }
        );
    },
