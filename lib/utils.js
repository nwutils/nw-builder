    ...
    return (
      readFile(plistInput, "utf8")
        ...
        .then(function (info) {
          ...
          if (
            !(
              Object.prototype.hasOwnProperty.call(options, "mac_document_types") ||
              Object.prototype.hasOwnProperty.call(options, "CFBundleDocumentTypes")
            )
          ) {
            info.CFBundleDocumentTypes = [];
          }

          if (!Object.prototype.hasOwnProperty.call(options, "UTExportedTypeDeclarations"))
