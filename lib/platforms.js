...
module.exports = {
    win32: {
        ...
        files: { // First file must be the executable
            ...
            '>0.9.2 <=0.10.1': ['nw.exe', 'ffmpegsumo.dll', 'icudtl.dat', 'libEGL.dll', 'libGLESv2.dll', 'nw.pak'],
            '>0.10.1':         ['nw.exe', 'ffmpegsumo.dll', 'icudtl.dat', 'libEGL.dll', 'libGLESv2.dll', 'nw.pak', 'locales']
        },
