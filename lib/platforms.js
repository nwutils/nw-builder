...
module.exports = {
    win32: {
        ...
        files: { // First file must be the executable
            ...
            '>=0.14.6': ['nw.exe', 'chromedriver.exe', 'd3dcompiler_47.dll', 'dbghelp.dll', 'ffmpeg.dll', 'icudtl.dll', 'libEGL.dll', 'libexif.dll', 'libGLESv2.dll', 'nacl_irt_x86_32.nexe', 'natives_blob.bin', 'node.dll', 'nw.dll', 'nw_100_percent.pak', 'nw_200_percent.pak', 'nw_elf.dll', 'nwjc.exe', 'payload.exe', 'resources.pak', 'snapshot_blob.bin'],
