...
module.exports = {
    win32: {
        ...
        files: { // First file must be the executable
            ...
            '>0.12.3': ['nw.exe', 'nw.dll', 'node.dll', 'ffmpeg.dll', 'icudtl.dat', 'libEGL.dll', 'libGLESv2.dll', 'nw_100_percent.pak', 'nw_200_percent.pak', 'resources.pak', 'locales', 'd3dcompiler_47.dll', 'nw_elf.dll', 'natives_blob.bin']
        },
    ...
    linux32: {
        ...
        files: { // First file must be the executable
            ...
            '>0.10.1 <=0.12.3': ['nw', 'nw.pak', 'libffmpegsumo.so', 'icudtl.dat', 'locales'],
            '>0.12.3': ['lib', 'locales', 'icudtl.dat', 'natives_blob.bin', 'nw', 'nw_100_percent.pak', 'resources.pak', ]
        },
