...
module.exports = {
    win32: {
        ...
        files: { // First file must be the executable
            ...
            '>=0.13.0': ['nw.exe', 'ffmpeg.dll', 'icudtl.dat', 'libEGL.dll', 'libGLESv2.dll', 'nw.dll', 'locales', 'd3dcompiler_47.dll', 'nw_elf.dll', 'natives_blob.bin', 'resources.pak', 'nw_100_percent.pak', 'nw_200_percent.pak', 'nw_material_100_percent.pak', 'nw_material_200_percent.pak', 'resources.pak', 'snapshot_blob.bin', 'node.dll']
        },
