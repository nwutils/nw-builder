...
module.exports = {
    ...
    osxarm: {
        ...
        downloads: {
            'osxarm-normal': 'https://github.com/corwin-of-amber/nw.js/releases/download/nw-v0.61.0/nw-0.61.0-osx-arm64.tar.xz',
            'osxarm-sdk': 'https://github.com/corwin-of-amber/nw.js/releases/download/v0.61.1-pre/nwjs-sdk-v0.61.1-osx-arm64.zip'
        },
