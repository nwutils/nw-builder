...
module.exports = {
    win32: {
        ...
        files: { // First file must be the executable
            ...
            '>=0.13.0': ['nw.exe', 'd3dcompiler_47.dll', 'dbghelp.dll', 'ffmpeg.dll', 'icudtl.dat', 'libEGL.dll', 'libGLESv2.dll', 'locales', 'natives_blob.bin', 'node.dll', 'nw.dll', 'nw_100_percent.pak', 'nw_200_percent.pak', 'nw_elf.dll', 'resources.pak', 'snapshot_blob.bin']
        },
