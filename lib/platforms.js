...
module.exports = {
    ...
    osxarm: {
        ...
        files: {
            '>=0.12.0': ['nwjs.app', 'libffmpeg.dylib'],
        },
        downloads: {
            'osxarm-normal': 'https://github.com/corwin-of-amber/nw.js/releases/download/nw-v0.62.0/nwjs-0.62.0-osx-arm64.tar.xz',
            'osxarm-sdk': 'https://github.com/corwin-of-amber/nw.js/releases/download/nw-v0.62.0/nwjs-sdk-v0.62.0-osx-arm64.zip'
        },
