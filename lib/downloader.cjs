...
module.exports = {
   ...
   *
   * @param  {stream}  tarstream    A Node bit stream of data to pipe as the archive is downloaded
   ...
   *
   * @param  {[type]}  zipfile      The location of the zip file to extract files from
   * @param  {string}  destination  The location to extract files to
   * @return {Promise}              Resolves { files, destination } or Rejects if the /unzip failed
   */
